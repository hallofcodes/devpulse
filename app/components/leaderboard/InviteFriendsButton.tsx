...
export default function InviteFriendsButton({
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 text-sm font-medium bg-blue-600/20 text-blue-600 hover:bg-blue-600/30 hover:text-blue-600 border border-blue-500/30 px-4 py-2 rounded-lg transition-all"
    >
