        ...
        return (
          ...
          >
            ...
            <div className="flex justify-between items-start mb-6 relative z-10">
              ...
              <div
                className={`flex flex-col items-center justify-center px-3 py-2 rounded-lg bg-white/[0.03] border border-white/5 backdrop-blur-md shadow-lg ${rankColor}`}
              >
            ...
            <div className="flex flex-col divide-y divide-white/5">
              {ranked.slice(3).map((user) => {
                ...
                return (
                  <div
                    key={user.user_id}
                    className="group relative flex flex-col md:flex-row items-start md:items-center px-4 sm:px-6 py-4 md:py-4 transition-colors hover:bg-white/[0.02] bg-transparent"
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-1 gap-2">
            {BADGE_LEGEND_HOURS.map((hours) => {
              ...
              return (
                <div
                  key={hours}
                  className="flex items-center justify-between px-3 py-2.5 rounded-lg bg-white/[0.02] border border-white/5 hover:bg-white/[0.06] transition-colors gap-2"
                >
                  <div
