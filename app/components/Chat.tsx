    ...
    <>
      ...
      <div className="flex h-220 sm:h-screen w-full bg-transparent text-gray-900 overflow-hidden relative">
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-white/30">
            <div>
              ...
              <div className="flex justify-between items-center px-2 mb-2 relative">
                ...
                <div className="relative">
                  <span
                    ...
                    className="text-[10px] text-gray-500 bg-gray-50 px-2 py-0.5 rounded cursor-pointer hover:bg-gray-100 flex items-center gap-1 select-none"
                  >
                  ...
                  {isDmSortOpen && (
                    <div className="absolute right-0 top-full mt-1 w-24 bg-white/95 backdrop-blur-xl border border-gray-200 rounded-md shadow-xl overflow-hidden z-[100] py-1 text-xs">
                      <button
                        onClick={() => {
              ...
              <div className="h-[72px] flex items-center justify-between px-4 sm:px-6 border-b border-gray-200 bg-white z-10 flex-shrink-0">
                <div className="flex items-center gap-2 sm:gap-3.5">
                  <button
                    ...
                    className="md:hidden w-9 h-9 rounded-full bg-gray-50 border border-gray-200 hover:bg-gray-100 flex items-center justify-center text-gray-500 transition"
                  >
                    <FontAwesomeIcon
                      icon={faChevronLeft}
                    ...
                    {attachments.map((file, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-red-600 hover:text-red-700 hover:bg-red-400/10 rounded-md px-1.5 py-0.5 ml-1 transition"
                        >
          ...
          >
            <div className="absolute top-4 right-4 xl:hidden">
              <button
                ...
                className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center text-gray-600 hover:text-gray-900"
              >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-white/30 border-t border-gray-200">
              <div>
                <div className="flex items-center justify-between cursor-pointer group mb-4">
                  <h3 className="text-[14px] font-semibold text-gray-600 group-hover:text-gray-900 transition tracking-wide">
                    Shared Media
                  </h3>
                  <FontAwesomeIcon
                    icon={faChevronDown}
                    className="text-gray-500 w-3.5 h-3.5 group-hover:text-gray-600 transition"
                  />
                </div>
                  ...
                  <>
                              ...
                              <>
                                ...
                                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                  <div className="w-8 h-8 rounded-full bg-black/50 flex items-center justify-center backdrop-blur-sm group-hover:scale-110 transition-transform">
                                    <FontAwesomeIcon
                                      icon={faPlay}
                                      className="w-3 h-3 text-gray-900 ml-0.5"
                                    />
                                  </div>
                                </div>
                              </>
                    ...
                    {showAllMedia && (
                      <button
                        ...
                        className="w-full mt-4 py-2.5 rounded-xl bg-gray-50 text-gray-600 text-[13px] font-bold hover:bg-gray-100 transition shadow-sm"
                      >
                        Show Less
                      </button>
                    )}
        ...
        {showModal && (
          <div className="fixed p-5 inset-0 flex items-center justify-center bg-black/70 z-50 backdrop-blur-sm">
            <div className="glass-card p-8">
              ...
              <div className="space-y-1 max-h-60 overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-gray-100 pr-1">
              ...
              <div className="flex justify-end mt-5 pt-3 border-t border-gray-200">
                <button
                  ...
                  className="px-5 py-2 text-sm font-semibold rounded-xl text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition"
                >
                  Cancel
                </button>
              </div>
