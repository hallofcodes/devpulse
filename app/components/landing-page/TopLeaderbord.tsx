...
function rankBadgeClasses(rank: number) {
  if (rank === 1) {
    return "border-yellow-400/50 bg-yellow-500/20 text-yellow-700";
  }
  if (rank === 2) {
      ...
      {top_members && top_members.length > 0 && (
        ...
        >
          ...
          <div className="glass-card border-gray-200 bg-gray-50 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-[72px_minmax(0,1fr)_110px] md:grid-cols-[72px_minmax(0,1fr)_120px_180px] gap-3 px-4 py-3 border-b border-gray-200 bg-white/[0.01]">
          ...
          <div className="glass-card mt-6 p-5 rounded-2xl border-gray-200 bg-gray-50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {BADGE_LEGEND_HOURS.map((hours) => {
                ...
                return (
                  <div
                    key={hours}
                    className="flex items-center justify-between px-3 py-2.5 rounded-lg bg-white/[0.01] border border-gray-200 hover:bg-gray-100 transition-colors gap-2"
                  >
                    <div
