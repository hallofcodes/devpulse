        ...
        >
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/signup"
                className="text-sm text-indigo-600 hover:text-indigo-600 font-medium flex items-center gap-1 group"
              >
                Create yours
          ...
          {featuredBoard && (
            <Link
              ...
              className="block glass-card rounded-3xl border-gray-200 bg-gray-50 p-6 mb-4 group hover:border-indigo-500/20 transition-colors"
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                <div>
                  <span className="inline-flex items-center rounded-md border border-indigo-400/30 bg-indigo-50 px-2.5 py-1 text-[11px] uppercase tracking-[0.1em] text-indigo-200 font-semibold mb-3">
                    Featured Arena
                  </span>
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 group-hover:text-indigo-200 transition-colors mb-1">
                    {featuredBoard.name}
                  </h3>
            ...
            {arenaBoards.map(
              (
                ...
                <Link
                  ...
                  className="rounded-2xl glass-card border-gray-200 bg-gray-50 p-4 group hover:bg-white/[0.035] hover:border-indigo-500/20 transition-all"
                  data-aos="fade-up"
                  data-aos-delay={(i * 60).toString()}
                >
                  <div className="flex items-center justify-between mb-3">
                    <span className="inline-flex items-center rounded-md border border-indigo-400/30 bg-indigo-50 px-2 py-1 text-[10px] uppercase tracking-[0.1em] text-indigo-200 font-semibold">
                      Arena #{i + 2}
                    </span>
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 group-hover:text-indigo-200 transition-colors mb-2 line-clamp-2">
                    {board.name}
                  </h4>
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/leaderboard"
              className="px-4 py-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-500/20 rounded-lg text-sm font-medium transition-colors"
            >
