        ...
        <section className="max-w-5xl mx-auto px-6 pb-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            <article className="lg:col-span-4 glass-card rounded-2xl border-gray-200 bg-gray-50 p-5">
              <p className="text-[11px] uppercase tracking-[0.14em] text-blue-200/80 font-semibold mb-3">
                Management View
              </p>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3 mb-3">
                        ...
                        <span className="text-xs text-blue-200 border border-blue-400/30 rounded-md px-2 py-1 whitespace-nowrap">
                      ...
                      <div className="h-1.5 rounded-full bg-gray-100 overflow-hidden mb-2">
                        <div
                          className="h-full bg-blue-400/90 rounded-full"
